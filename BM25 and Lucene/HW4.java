...
public class HW4 {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Enter the path of the query file");
		String name = br.readLine();
		
		System.out.println("Enter the path of the text file where ranking will be stored");
		...
		String FinalScore = outputname;
		//String FinalScore = "/Users/sonalsingh/Desktop/IR_hw4/luceneRanking.txt";
		FileWriter fw = new FileWriter(FinalScore);
		BufferedWriter writer = new BufferedWriter(fw);
		ql = readQueryFile(name);
		for(String key: ql.keySet()) {
		//while (!s.equalsIgnoreCase("q")) {
			TopScoreDocCollector collector = TopScoreDocCollector.create(100, true);
			try {
				String query = ql.get(key);
				System.out.println("query Id:" + key);
				System.out.println("working with the query:" + ql.get(key));
				...
				for (int i = 0; i < hits.length; ++i) {
					...
					String fname = new File(d.get("path")).getName();
					writer.write(key +" Q0 " + fname + " " + (i+1) + " " + hits[i].score + " SimpleAnalyzerLucene" + "\n"); 
				}
	...
	public static HashMap<String,String> readQueryFile(String filename) {
		HashMap<String, String> queryList = new HashMap<String, String>();
		
		
		try {
			File file = new File(filename);
			//File file = new File("/Users/sonalsingh/Desktop/IR_hw4/queries.txt");
